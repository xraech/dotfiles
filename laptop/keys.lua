...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "r",
        function()
            awful.spawn.with_shell("rofi -matching fuzzy -sort true -show combi")
        end,
    ...
    awful.key( { }, "XF86AudioMute",
        function()
			awful.spawn.with_shell("sh ~/.config/scripts/volume toggle")
			-- helpers.volume_control(0)
        end,
        {description = "(un)mute volume", group = "volume"}),
    awful.key( { }, "XF86AudioLowerVolume",
        function()
			awful.spawn.with_shell("sh ~/.config/scripts/volume down")
            --helpers.volume_control(-5)
        end,
        {description = "lower volume", group = "volume"}),
    awful.key( { }, "XF86AudioRaiseVolume",
        function()
			awful.spawn.with_shell("sh ~/.config/scripts/volume up")
            -- helpers.volume_control(5)
        end,
    ...
    awful.key({ superkey }, "F4", function() helpers.toggle_scratchpad() end,
