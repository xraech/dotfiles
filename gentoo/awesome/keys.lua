...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("menu run") end,
...
local vol = function(step)
	...
	if signal == "+" and out == "[off]\n" then
		...
		awful.spawn.easy_async_with_shell(vol_cmd, function(vol)
		    awful.spawn.easy_async_with_shell("getprogressstring 10 '' '' " .. vol, function(bar)
...
awful.keyboard.append_global_keybindings({
    awful.key({ }, "XF86AudioLowerVolume", function () vol(-1) end,
              {description = "decreases volume by 1", group = "audio"}),
    awful.key({ }, "XF86AudioRaiseVolume", function () vol(1) end,
