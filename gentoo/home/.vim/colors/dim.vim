...
if &background == "light"
  highlight StatusLine   ctermfg=15   ctermbg=8
  highlight StatusLineNC ctermfg=15   ctermbg=8    cterm=NONE
  highlight WildMenu     ctermfg=15   ctermbg=8
else
  highlight StatusLine   ctermfg=8    ctermbg=15
  highlight StatusLineNC ctermfg=8    ctermbg=15    cterm=NONE
  highlight WildMenu     ctermfg=8    ctermbg=15
endif
