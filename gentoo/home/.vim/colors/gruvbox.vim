...
let s:gb.gray_244    = ['#665c54', 244]     " 146-131-116

let s:gb.light0_hard = ['#f9f5d7', 230]     " 249-245-215
let s:gb.light0      = ['#fbf1c7', 229]     " 253-244-193
let s:gb.light0_soft = ['#c4bfa9', 228]     " 242-229-188
let s:gb.light1      = ['#ebdbb2', 223]     " 235-219-178
let s:gb.light2      = ['#b2ac98', 250]     " 213-196-161
let s:gb.light3      = ['#bdae93', 248]     " 189-174-147
let s:gb.light4      = ['#a89984', 246]     " 168-153-132
let s:gb.light4_256  = ['#a89984', 246]     " 168-153-132

let s:gb.bright_red     = ['#fb4934', 167]     " 251-73-52
let s:gb.bright_green   = ['#00ff00', 142]     " 184-187-38
...
let s:gb.faded_red      = ['#8d0006', 88]      " 157-0-6
let s:gb.faded_green    = ['#1F6430', 100]     " 121-116-14
let s:gb.faded_yellow   = ['#8B4513', 136]     " 181-118-20
let s:gb.faded_blue     = ['#076678', 24]      " 7-102-120
let s:gb.faded_purple   = ['#8f3f71', 96]      " 143-63-113
let s:gb.faded_aqua     = ['#2F68A0', 66]      " 66-123-88
let s:gb.faded_orange   = ['#65408F', 130]     " 175-58-3
...
if version >= 703
  ...
  call s:HL('CursorLineNr', s:fg0, s:bg2)
endif
