...
let colors_name = "handmade-white"
...
let s:mark = ["#808080", 0]
let s:comment = ["#796949", 0]
let s:keyword = ["#151515", 0]
let s:constant = ["#0c8423", 0]
let s:preproc = ["#b5966e", 0]
let s:special = ["#cd664d", 0]
let s:bar = ["#CACACA", 0]
let s:bar_active = ["#A8A8A8", 0]
let s:base = ["#000000", 0]
let s:character = ["#4b84ce", 0]

let s:none = ['NONE', 'NONE']
let s:underline = 'underline,'

call s:HL('Char', s:character)
hi! link Character Char
...
call s:HL('LineNr', s:comment, s:back)
...
call s:HL('Todo', s:constant, s:back)
...
autocmd ColorScheme handmade-white hi! link Sneak Search
autocmd ColorScheme handmade-white hi! link SneakLabel Search
...
call s:HL('MatchParen',  s:back, s:comment) 
