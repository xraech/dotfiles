...
hi  Normal                                  ctermfg=12  ctermbg=8  guifg=#4d855b  guibg=#1b1f2b  gui=NONE

set background=dark

hi  ColorColumn                             ctermbg=0  guibg=#282c36  gui=NONE
hi  Comment                                 ctermfg=10  guifg=#595d6b  gui=NONE
hi  ConId                                   ctermfg=3  guifg=#8a7845  gui=NONE
hi  Conceal                                 ctermfg=4  guifg=#4a7994  gui=NONE
hi  Constant                                ctermfg=6  guifg=#1496bb  gui=NONE
